                        ...
                        @endif
                            ...
                            <form action="{{ route('products.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control" id="value_sale" name="value_sale" value="{{ old('value_sale') }}">
                                </div>

                                <div class="form-group">
                                    <label for="value_cost">R$ Custo</label>
                                    <input type="number" step="any" class="form-control" id="value_cost" name="value_cost" value="{{ old('value_cost') }}">
                                </div>
